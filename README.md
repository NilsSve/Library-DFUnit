...
>
> **Renamed 2026-09-24, and again 2026-09-25:** the package file is now `RDC-DFUnit-Library.sws` -
> every RDC Tools package is named `RDC-<name>-Library`, with no DataFlex version in the name. The same
> rule applies: the new `"sws"` name goes in the same edit as a `"version"` at or after that commit.
